# skill-enabled-state Specification

## Purpose

Define how skill `enabled` flags are persisted, surfaced in Settings, and enforced by the Agent runtime so UI toggles control which skills the SDK loads.
